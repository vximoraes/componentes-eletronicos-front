...
Testes Automatizados: Serão realizados testes end-to-end com Cypress cobrindo os fluxos principais: login, componentes (listagem, cadastro, edição, exclusão, movimentações), orçamentos (listagem, cadastro, edição, exclusão).
